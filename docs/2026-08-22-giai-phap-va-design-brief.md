...
**Phase 10 (phone layout) implemented 2026-08-26.** App vốn dựng cho iPad ngang, không dùng được trên điện thoại (CTA chính nằm dưới nếp gấp). Thêm mốc breakpoint thật: không tiền tố = điện thoại (<640), `md:` = tablet dọc (768), `ipad:` = iPad ngang (1194, mốc mới thay cho `lg:` 1024). Bản đồ đảo bị **bỏ dưới mốc tablet**, thay bằng lưới thẻ chủ đề 2 cột; các màn luyện nói/nghe/đố đều dựng lại vừa khít 844px không cuộn; bước đoán nghĩa có nút "Tiếp theo →" tường minh ở mọi mốc thay vì tự chuyển sau 1.5s. Góc phụ huynh **giữ lại** thẻ "Bản ghi gần đây" trên điện thoại (khác thiết kế gốc), thu vào dạng `<details>` đóng sẵn. Chi tiết đầy đủ: mục "Phase 10" trong README.md; các quyết định và sai khác được chấp nhận: `docs/superpowers/specs/2026-08-26-phase10-mobile-layout-design.md`.
